  ...
  const onSubmit = async (data) => {
    ...
    if (body.ok) {
      ...
      if (body.rol == 0) {
        ...
        if (dataShopping.productos.length > 0) {
            props.navigate('/cart')
            return toggleUser(body)
        } else {
          props.navigate('/')
        ...
        <Col xl={6}>
          <div className="card mb-4">
            <div className="card-body">
              ...
              aliquam nulla magnam atque ab similique nam, animi voluptas eos
              minus iste quos, ad corporis officia? Facilis harum adipisci
              cupiditate repellat!
            </div>
          </div>
        </Col>
